...
async function register(req, res) {
    try {
        const { nom, prenom, email, password, role, specialite, classes, vms } = req.body;
...
module.exports = { register, login, getById, getTeachers, addTeacher, updateTeacher, deleteTeacher, deleteTeachers, upload };
